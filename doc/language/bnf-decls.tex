...
{\hlink{IdOp}\opt{\hlink{DeclFormals}}\ \opt{\{\lit{,} \hlink{IdOps} \}
    \choice \ite{\hlink{Bindings}}} \\[-0.1in]
  & & \lit{:} \hlink{TypeExpr} \opt{\lit{=} \hlink{Expr}}}
...
{\opt{\hlink{IdOp}\opt{\hlink{DeclFormals}} \lit{:}} \lit{JUDGEMENT} \\[-0.1in]
  & & \quad \ites{\hlink{TypeExpr}}{,} \lit{SUBTYPE\_OF} \hlink{TypeExpr}}

\production{ConstantJudgement}
{\opt{\hlink{IdOp}\opt{\hlink{DeclFormals}} \lit{:}} \opt{\lit{RECURSIVE}}
  \lit{JUDGEMENT} \\[-0.1in]
  && \quad \ites{\hlink{ConstantReference}}{,} \lit{HAS\_TYPE} \hlink{TypeExpr}}
