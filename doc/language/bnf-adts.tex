...
\choice \lit{CODATATYPE}} \opt{\lit{WITH} \lit{SUBTYPES} \hlink{Ids}}\\[-0.1in]
&& \lit{BEGIN}\\[-0.1in]
...
{\hlink{Id} \opt{\hlink{DeclFormals}} \lit{:} \brc{\lit{DATATYPE} \choice \lit{CODATATYPE}} \opt{\lit{WITH} \lit{SUBTYPES} \hlink{Ids}}\\[-0.1in]
&& \lit{BEGIN}\\[-0.1in]
&& \opt{\hlink{Importing} \opt{\lit{;}}} \\[-0.1in]
&& \opt{\hlink{AssumingPart}} \\[-0.1in]
