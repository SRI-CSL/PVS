...
\icmd{pvs-set-proof-prompt-behavior} & Sets the kind of prompting at
the end of a proof;\\
 & one of \texttt{ask}, \texttt{dont-ask}, or
 \texttt{noquestions} (same as \texttt{dont-ask} but silent)\\
 \icmd{pvs-set-undo-prompt-behavior} & Sets the kind of prompting when
undoing a proof command;\\
 & one of \texttt{ask}, \texttt{dont-ask}, or
 \texttt{noquestions} (same as \texttt{dont-ask} but silent)\\
 \icmd{pvs-set-quit-prompt-behavior} & Sets the kind of prompting when
quitting or aborting a proof;\\
 & one of \texttt{ask}, \texttt{dont-ask}, or
 \texttt{noquestions} (same as \texttt{dont-ask} but silent)\\
 \icmd{pvs-set-all-prompt-behavior} & Sets the kind of prompting for
proof, undo, and quit commands;\\
 & one of \texttt{ask}, \texttt{dont-ask}, or
\texttt{noquestions} (same as \texttt{dont-ask} but silent)\\
\end{pvscmdsna}
...
\begin{tabular}{rp{11cm}}
  ...
  \texttt{dont-ask} & overwrite the earlier proof and announce the change\\
  \texttt{noquestions} & same as \texttt{dont-ask} but silent.
\end{tabular}
