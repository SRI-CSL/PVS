...
\input{/project/pvs/doc/refcard/pvs-files}

\input{/project/pvs/doc/refcard/latex-ref}

\newcolumn
\title{\titlepvs\ Language Summary}
\markright{PVS Language Summary}
\addcontentsline{toc}{section}{\numberline{2} PVS Language Summary}
\input{/project/pvs/doc/refcard/language-ref}
...
\input{/project/pvs/doc/refcard/emacs-commands}
...
\input{/project/pvs/doc/refcard/prover-cmds}

\wiftnewpage

\markright{PVS Prover Emacs Shortcuts}
\input{/project/pvs/doc/refcard/prover-emacs-cmds}
