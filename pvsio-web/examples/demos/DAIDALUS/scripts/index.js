...
require(["PVSioWebClient", "util/PVSioStateParser",
         "d3/d3", "../../demos/DAIDALUS/scripts/TCASView"], function (PVSioWebClient, StateParser, d3, TCASView) {
    "use strict";
    ...
    client.addListener("WebSocketConnectionOpened", function (e) {
        ...
        ws.startPVSProcess({name: "top.pvs", demoName: "DAIDALUS/pvs"}, function (err, event) {
