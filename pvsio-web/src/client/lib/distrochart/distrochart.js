...
function makeDistroChart(settings) {
    ...
    function tooltipHover(groupName, metrics) {
        var tooltipString = "<b>" + groupName + "</b>";
        ...
        return function () {
            chart.objs.tooltip.style("opacity", 0.9).style("position", "fixed");
            chart.objs.tooltip.html(tooltipString)
                    .style("left", (d3.event.clientX + 32) + "px")
    ...
    chart.update = function () {
        ...
        chart.width = parseInt(chart.objs.chartDiv.select("svg").style("width"), 10) - (chart.margin.left + chart.margin.right);
        chart.height = parseInt(chart.objs.chartDiv.select("svg").style("height"), 10) - (chart.margin.top + chart.margin.bottom);
