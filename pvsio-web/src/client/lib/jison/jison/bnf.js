define(function (require, exports, module) {
    ...
    var bnf = require("lib/jison/jison/util/bnf-parser").parser;
    var jisonlex = require("lib/jison/jison/jisonlex");
    module.exports.parse = function parse () { return bnf.parse.apply(bnf, arguments) };
