...
define(function (require, exports, module) {
    ...
    var typal = require("lib/jison/jison/util/typal").typal;
    var Set = require("lib/jison/jison/util/set").Set;
    var RegExpLexer = require("lib/jison/jison/lexer").RegExpLexer;

    var Jison = exports.Jison = {};
    ...
    generator.constructor = function Jison_Generator (grammar, opt) {
        if (typeof grammar === 'string') {
            grammar = require("lib/jison/jison/bnf").parse(grammar);
        }
...
//            var grammar = require("lib/jison/jison/bnf").parse(gfile.read({charset: "utf-8"}));
//        }
//
...
//                grammar.lex = require("lib/jison/jison/jisonlex").parse(lfile.read({charset: "utf-8"}));
//            }
//        }
//
//        if (!opt.moduleName)
