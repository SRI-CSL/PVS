...
(function(mod) {
  ...
  "use strict";
    ...
    var modellingKeywords =  "if|then|else|implies|or|and|not".split("|");
    var modellingKeywordsCapitalised = "IF|THEN|ELSE|IMPLIES|OR|AND|NOT".split("|");
    
    var storageType = "real|int|integer|nat|bool|boolean|char".split("|");

    var builtinConstants = "true|false".split("|");

    var preludeFunctionsAndConstants = "upto|below|upfrom|ceiling|floor|fractional|add|remove|choose|the".split("|");


  CodeMirror.registerHelper("hint", "emucharts", function(editor, options) {
