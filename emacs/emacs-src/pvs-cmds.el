...
(defvar *prelude-files-and-regions*
  (mapcar
    ...
    '(("character_adt.pvs"
       ("character_adt" 1 2007)
       ("character_adt_reduce" 2007 2560))
      ("lift_adt.pvs"
       ("lift_adt" 1 2525)
       ("lift_adt_map" 2525 2847)
       ("lift_adt_reduce" 2847 3427))
      ("list_adt.pvs"
       ("list_adt" 1 3926)
       ("list_adt_map" 3926 4370)
       ("list_adt_reduce" 4370 5157))
      ("ordstruct_adt.pvs"
       ("ordstruct_adt" 1 3454)
       ("ordstruct_adt_reduce" 3454 4567))
      ("prelude.pvs"
       ("booleans" 1 1515)
       ("equalities" 1515 1728)
       ("notequal" 1728 1826)
       ("if_def" 1826 2106)
       ("boolean_props" 2106 3161)
       ("xor_def" 3161 3465)
       ("quantifier_props" 3465 4462)
       ("defined_types" 4462 4764)
       ("exists1" 4764 5381)
       ("equality_props" 5381 5852)
       ("if_props" 5852 6223)
       ("functions" 6223 7771)
       ("functions_alt" 7771 8000)
       ("restrict" 8000 8541)
       ("extend" 8541 8937)
       ("extend_bool" 8937 9199)
       ("K_conversion" 9199 9381)
       ("K_props" 9381 9518)
       ("identity" 9518 9876)
       ("identity_props" 9876 10113)
       ("relations" 10113 10993)
       ("orders" 10993 13989)
       ("orders_alt" 13989 14527)
       ("wf_induction" 14527 14870)
       ("measure_induction" 14870 15306)
       ("epsilons" 15306 15944)
       ("sets" 15944 17749)
       ("sets_lemmas" 17749 23567)
       ("function_inverse" 23567 25535)
       ("function_image" 25535 27133)
       ("function_props" 27133 28352)
       ("function_props_alt" 28352 28965)
       ("function_props2" 28965 29308)
       ("relation_defs" 29308 30470)
       ("relation_props" 30470 31055)
       ("relation_props2" 31055 31255)
       ("operator_defs" 31255 32100)
       ("numbers" 32100 32430)
       ("reals" 32430 33595)
       ("real_axioms" 33595 34926)
       ("bounded_real_defs" 34926 36512)
       ("bounded_real_defs_alt" 36512 37020)
       ("real_types" 37020 39241)
       ("rationals" 39241 42644)
       ("integers" 42644 47056)
       ("naturalnumbers" 47056 48638)
       ("min_nat" 48638 48943)
       ("real_defs" 48943 52091)
       ("real_props" 52091 64973)
       ("rational_props" 64973 65465)
       ("integer_props" 65465 65994)
       ("floor_ceil" 65994 68054)
       ("exponentiation" 68054 73444)
       ("euclidean_division" 73444 74486)
       ("divides" 74486 76826)
       ("modulo_arithmetic" 76826 79369)
       ("subrange_inductions" 79369 80014)
       ("bounded_int_inductions" 80014 80798)
       ("bounded_nat_inductions" 80798 81621)
       ("subrange_type" 81621 81734)
       ("int_types" 81734 81944)
       ("nat_types" 81944 82150)
       ("finite_sets_def" 82150 84662)
       ("function_iterate" 84662 85489)
       ("sequences" 85489 86948)
       ("seq_functions" 86948 87270)
       ("finite_sequences" 87270 88705)
       ("ordstruct" 88705 88913)
       ("ordinals" 88913 90785)
       ("lex2" 90785 91293)
       ("list" 91293 91437)
       ("list_props" 91437 93452)
       ("map_props" 93452 93837)
       ("filters" 93837 94734)
       ("list2finseq" 94734 95257)
       ("list2set" 95257 95514)
       ("character" 95514 96839)
       ("strings" 96839 98245)
       ("lift" 98245 98325)
       ("union" 98325 98420)
       ("mucalculus" 98420 99540)
       ("ctlops" 99540 100220)
       ("fairctlops" 100220 101459)
       ("Fairctlops" 101459 102741))
      ("union_adt.pvs"
       ("union_adt" 1 3197)
       ("union_adt_map" 3197 3689)
       ("union_adt_reduce" 3689 4371)))))
