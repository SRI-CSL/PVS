...
;; sort of information.
(defconst tcl-using-emacs-19-or-20 (string-match "^\\(19\\|20\\)\\." emacs-version)
  "Nil unless using Emacs 19 or 20 (Lucid or FSF).")

;; FIXME this will break on Emacs 19.100.
(defconst tcl-using-emacs-19-23
  (string-match "^\\(19\\.\\(2[3-9]\\|[3-9][0-9]\\)\\|20\\)" emacs-version)
...
(fset 'tcl-end-of-defun
      (if (and tcl-using-emacs-19-or-20 (not tcl-using-lemacs-19))
	  'end-of-defun
	'tcl-internal-end-of-defun))
...
(defun tcl-auto-fill-mode (&optional arg)
  ...
  (interactive "P")
  (and (not tcl-using-emacs-19-or-20)
